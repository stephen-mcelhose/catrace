...
| 2  | Prompt Chaining           | Linear pipeline      | N sequential agents, optional gate between each      | Output of each step feeds as input to the next. Gates validate intermediate results before continuing.                                    | ANT, LG    | [story-prompt-chaining](story-prompt-chaining.md)      | —                                     |
...
| *planned*              | Prompt Chaining (2), Routing (3), Parallelisation (4), Orchestrator-Workers (5), Supervisor (8), Swarm (9), Blackboard (10), Debate (11), Plan-and-Execute (12) |
