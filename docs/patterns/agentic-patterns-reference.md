...
| 10 | Blackboard                | Star (shared memory) | N specialist agents + shared blackboard              | Agents read from and write to a central shared workspace; any agent may contribute whenever it can advance the solution.                  | —          | [story-blackboard](story-blackboard.md)                | `blackboard`                          |
...
| *planned*              | Routing (3), Parallelisation (4), Orchestrator-Workers (5), Supervisor (8), Swarm (9), Debate (11), Plan-and-Execute (12) |
