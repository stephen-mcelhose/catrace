...
## [2026-08-05] ingest | examples/routing/WALKTHROUGH.md

Pages written: example-routing.md
Propagated to: agentic-patterns-catalogue.md (pattern 3 marked implemented, example link added)
